...
function validation(){
    ...
    if(validation==6){
            ...
            row.insertCell(6).innerHTML = `<button onClick="onEdit(this)">MODIFIER</button>
                                           <button onClick="onDelete(this)">SUPPRIMER</button>`;
          }
...
function onEdit(td) {
  selectedRow = td.parentElement.parentElement;
    ...
    document.getElementsByName("type").value = selectedRow.cells[5].innerHTML;
}
